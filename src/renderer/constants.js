...
export const FILE_REFERENCE_PATTERN =
  /(?<![A-Za-z0-9._\\/\-])((?:(?:[A-Za-z]:[\\\/]|\\\\[A-Za-z0-9._\- ]+\\)(?:[A-Za-z0-9._\- ]+[\\\/])*[A-Za-z0-9._\- ]+|(?:\.{1,2}[\\\/]|~\/|\/)(?:[A-Za-z0-9._\-]+[\\\/])*[A-Za-z0-9._\-]+|(?:[A-Za-z0-9._\-]+[\\\/])+[A-Za-z0-9._\-]+|[A-Za-z0-9._\-]+\.[A-Za-z0-9._\-]+|\.[A-Za-z0-9._\-]+))(?:(?:[:#](\d+)(?::\d+)?)|\((\d+)(?:,\d+)?\))?(?![A-Za-z0-9._\\/\-])/g;
