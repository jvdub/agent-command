...
export const agenticApp = Object.freeze({
  ...
  refreshManagedRunShapeReview: (runId) =>
    call("managedRuns", "refreshShapeReview", runId),
  ...
  refreshManagedRunSpecReview: (runId) => call("managedRuns", "refreshSpecReview", runId),
  ...
  refreshManagedRunTicketsReview: (runId) => call("managedRuns", "refreshTicketsReview", runId),
  ...
  decideManagedRunRevisionCommit: (runId, ticketId, disposition, reversalTicketId = null) =>
    call("managedRuns", "decideRevisionCommit", runId, ticketId, disposition, reversalTicketId),
  ...
  retryManagedRunTask: (runId, taskId) => call("managedRuns", "retryTask", runId, taskId),
  updateManagedRunTicketBudget: (runId, taskId, maxAttempts) => call("managedRuns", "updateTicketBudget", runId, taskId, maxAttempts),
  updateManagedRunIntegrationLimits: (runId, cycles, attempts) => call("managedRuns", "updateIntegrationLimits", runId, cycles, attempts),
