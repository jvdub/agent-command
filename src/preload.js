...
const agentic = {
  ...
  managedRuns: {
    ...
    refreshShapeReview: (runId) =>
      ipcRenderer.invoke(IPC_CHANNELS.invoke.refreshManagedRunShapeReview, { runId }),
    ...
    previewAcceptance: (runId) => ipcRenderer.invoke(IPC_CHANNELS.invoke.previewManagedRunAcceptance, runId),
    accept: (runId, options = {}) =>
